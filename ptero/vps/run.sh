...
hostnamectl set-hostname CODINGPRIME 2>/dev/null
    ...
    while true; do
        ...
        case $p_opt in
            1) echo -e "\n  ${B_BLUE}➜ Installing Cockpit...${NC}"
               bash <(curl -s https://raw.githubusercontent.com/DeVv-Prime/ptero/refs/heads/main/ptero/vps/panel/cockpit.sh); pause ;;
            2) echo -e "\n  ${B_BLUE}➜ Installing CasaOS...${NC}"
               bash <(curl -s https://raw.githubusercontent.com/DeVv-Prime/ptero/refs/heads/main/ptero/vps/panel/casaos.sh); pause ;;
            3) echo -e "\n  ${B_BLUE}➜ Installing 1Panel...${NC}"
               bash <(curl -s https://raw.githubusercontent.com/DeVv-Prime/ptero/refs/heads/main/ptero/vps/panel/1panel.sh); pause ;;
            0) break ;;
